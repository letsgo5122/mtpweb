...
signal play
signal quit_game
signal gameMenuSetting(CkBt, limitTime,firstPlayer)
var CkBt:bool = false
...
func _on_check_button_toggled(button_pressed):
	CkBt = button_pressed
	SendGameMenu.rpc(CkBt, limitTime, firstPlayer)
	pass # Replace with function body.
...
func SendGameMenu(CkBt, limitTime, firstPlayer):
	gameMenuSetting.emit(CkBt, limitTime, firstPlayer)
